...
for wm_subDirID = 1 : size(VA_TRANS.f.classSubDir,2)
    ...
    VA.set.autorun.f.load.path = [VA_TRANS.f.dataDir,filesep]; 
    VA.w.wm_subDirID = wm_subDirID;
    VA.set.autorun.f.save.path = [VA_TRANS.f.baseDir,filesep,VA_TRANS.f.A09_EEG_validation.subDir,filesep,VA_TRANS.f.classSubDir{wm_subDirID},filesep];
...
for wm_subDirID = 1 : size(VA_TRANS.f.classSubDir,2)
    ...
    VA.set.autorun.f.load.path.validation = [VA_TRANS.f.baseDir,filesep,VA_TRANS.f.A09_EEG_validation.subDir,filesep,VA_TRANS.f.classSubDir{wm_subDirID},filesep];
    VA.set.autorun.f.save.path = [VA_TRANS.f.baseDir,filesep,VA_TRANS.f.A10_offlineClass_prep.subDir,filesep,VA_TRANS.f.classSubDir{wm_subDirID},filesep];
    if ~isfolder(VA.set.autorun.f.save.path)
      mkdir(VA.set.autorun.f.save.path)
    end
...
for wm_subDirID = 1 : size(VA_TRANS.f.classSubDir,2)
    ...
    VA.set.autorun.f.load.path.offlineClass_prep = [VA_TRANS.f.baseDir,filesep,VA_TRANS.f.A10_offlineClass_prep.subDir,filesep,VA_TRANS.f.classSubDir{wm_subDirID},filesep];
    VA.set.autorun.f.save.path = [VA_TRANS.f.baseDir,filesep,VA_TRANS.f.A10B_offlineTrial_validation.subDir,filesep,VA_TRANS.f.classSubDir{wm_subDirID},filesep];
...
for wm_subDirID = 1 : size(VA_TRANS.f.classSubDir,2)
    ...
    VA.set.autorun.f.load.path.offlineClass_prep = [VA_TRANS.f.baseDir,filesep,VA_TRANS.f.A10_offlineClass_prep.subDir,filesep,VA_TRANS.f.classSubDir{wm_subDirID},filesep];
    VA.set.autorun.f.load.path.tr_validMask = [VA_TRANS.f.baseDir,filesep,VA_TRANS.f.A10B_offlineTrial_validation.subDir,filesep,VA_TRANS.f.classSubDir{wm_subDirID},filesep];
    VA.set.autorun.f.save.path = [VA_TRANS.f.baseDir,filesep,VA_TRANS.f.A11_offlineClass_classSetup.subDir,filesep,VA_TRANS.f.classSubDir{wm_subDirID},filesep];
    if ~isdir(VA.set.autorun.f.save.path)
      mkdir(VA.set.autorun.f.save.path)
    end
...
for wm_subDirID = 1 : size(VA_TRANS.f.classSubDir,2)
  ...
  result.orig.basis.testTrials = sum(result.orig.basis.testTrials_per_class);
    ...
    % wm1 = [VA_TRANS.f.baseDir,'\+ FBCSP0\',VA_TRANS.f.classSubDir{1},'\A',subFunc_num2str_2digit(result.orig{1, 1}.opt_tt.optionID),filesep];
...
% % % % % % % %       autorun.tt.file.save.path.offlineClass_trainTest = [VA.f.baseDir,filesep,VA.f.FBCSP_offline_trainTest_taskManager.subDir,filesep,VA.f.classSubDir{wm_subDirID},'\A',num2str(subFunc_num2str_2digit(wm_taskID)),filesep];
