...
VA_TRANS.f.dataDir = fullfile(VA_TRANS.f.workDir, 'TMP Data'); % !!!!!!!!!!!!!!!! CHECK THIS !!!!!!!!!!!!!!!! % =1: task VS relax classification pair used
VA_TRANS.f.baseDir = fullfile(VA_TRANS.f.workDir, 'TrainTest'); % !!!!!!!!!!!!!!!! CHECK THIS !!!!!!!!!!!!!!!! % =1: task VS relax classification pair used
...
function VA_TRANS = config_modification(STACK, V1_TRANS, VA_TRANS)
    ...
    if exist('wm', 'var')
        ...
        elseif (wm12 == 91) || (wm12 == 92)
            ...
            error('Unknown wm_taskID: %d', wm_taskID);
