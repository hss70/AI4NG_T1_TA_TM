...
V1_TRANS.f.SourceDataDir =  fullfile(V1_TRANS.f.HomeDir,'Work','SourceData (EEG_rec)');   % !!!!!!!!!!!!!!!! CHECK THIS !!!!!!!!!!!!!!!!
% 
% V1_TRANS.f.SourceDataName = 'tr.mat';   % !!!!!!!!!!!!!!!! CHECK THIS !!!!!!!!!!!!!!!!
V1_TRANS.f.SourceDataName = 'EEG_rec.mat';   % !!!!!!!!!!!!!!!! CHECK THIS !!!!!!!!!!!!!!!!

V1_TRANS.f.PreviousResultDir = fullfile(V1_TRANS.f.HomeDir,'Work','T1','Results');   % !!!!!!!!!!!!!!!! CHECK THIS !!!!!!!!!!!!!!!! % ='': full data - OTHERWISE: have to set old result T1/Result dir for expeption of currently processed data
...
V1_TRANS.f.BaseDir = fullfile(V1_TRANS.f.HomeDir,'Work');   % !!!!!!!!!!!!!!!! CHECK THIS !!!!!!!!!!!!!!!! % =1: task VS relax classification pair used      
...
V1_TRANS.f.chanlocs_dir = fullfile(V1_TRANS.f.HomeDir,'Code');
...
%% Comments
% Edited by Hardeep on 2025-06-29 to make platform independent
